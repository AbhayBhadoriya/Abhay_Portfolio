        ...
        return(
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              <div className="author-img" style={{backgroundImage: 'url('+"http://localhost:3000/react-prtfolio/images/IMG_0081.jpg"+')'}} />
              <h1 id="colorlib-logo"><a href="index.html">ABH</a></h1>
